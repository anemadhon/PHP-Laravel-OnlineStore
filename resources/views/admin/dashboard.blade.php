        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-3">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-1 mx-4 bg-white border-b border-gray-200">
                    hi, {{ auth()->user()->name }}. Cause you are an ADMINISTRATOR, please complete your data <span class="text-indigo-600 hover:text-indigo-900 underline"><a href="{{ route('profile', ['user' => auth()->user()]) }}" class="underline">here</a></span>
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Most Active User</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            The Most Active Users awarded to : <strong> {{ $user_active }} </strong>. Thank you for completing <strong>{{ $user_transaction }}</strong> transactions
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Most Popular Categories</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            The Most Popular Categories awarded to : <strong>{{ $favorite_category }}</strong>. <strong>{{ $favorite_category }}</strong> has got <strong>{{ $category_transaction }}</strong> transactions
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Most Popular Store</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            The Most Popular Store awarded to : <strong>{{ $favorite_store }}</strong>. Thank you for getting <strong>{{ $store_transaction }}</strong> transactions
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Most Biggest Revenue</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            The Most Biggest Revenue awarded to : <strong>{{ $store_revenue_name }}</strong>. Congratulations for getting <strong>Rp. {{ number_format($store_revenue,2) }}</strong>
                        </div>
                    </div>
                </div>
            </div>
