                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-8 h-8 mr-3 rounded-full md:block">
                                                    ...
                                                    {{-- <img class="object-cover w-full h-full rounded-full" src="{{ asset('storage/'.$user->icon) }}" alt="userss avatar" loading="lazy" /> --}}
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            {{ $user->role.' -'.($user->has_store ? 'Seller, Buyer-' : 'Buyer-') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <a href="{{ route('admin.users.show', $user) }}"><span class="px-2 mr-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-100 text-indigo-600 hover:text-indigo-900">Show</span></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
